...
df = pd.read_csv('2_Absenteeism_at_work.csv', sep=';')
...
train.drop(['Absenteeism time in hours'], axis=1, inplace=True)
train.drop(['ID'], axis=1, inplace=True)

test.drop(['ID'], axis=1, inplace=True)
test.drop(['target'], axis=1, inplace=True)
test.drop(['Absenteeism time in hours'], axis=1, inplace=True)
...
encoded_train.to_csv('train_abs_encoded.csv', index=False)
encoded_test.to_csv('test_abs_encoded.csv', index=False)
