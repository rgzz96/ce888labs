...
encoded_train['Risk'] = target.values
encoded_test['Risk'] = target_test.values

#Encoded data dumped to CSV in for further use
encoded_train.to_csv('train_audit_encoded.csv', index=False)
encoded_test.to_csv('test_audit_encoded.csv', index=False)